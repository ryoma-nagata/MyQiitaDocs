...
const Article = ({ renderedBody, tags, title, slide }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("article", { css: containerStyle, children: [(0, jsx_runtime_1.jsx)("h1", { css: titleStyle, children: title }), (0, jsx_runtime_1.jsxs)("div", { css: tagListWrapStyle, children: [(0, jsx_runtime_1.jsx)(MaterialSymbol_1.MaterialSymbol, { fill: true, css: { color: variables_1.Colors.mediumEmphasis }, children: "sell" }), (0, jsx_runtime_1.jsx)("ul", { css: tagListStyle, children: tags.map((tag, index) => ((0, jsx_runtime_1.jsxs)("li", { children: [(0, jsx_runtime_1.jsx)("span", { children: tag }), index !== tags.length - 1 && (0, jsx_runtime_1.jsx)("span", { children: "," })] }, tag))) })] }), (0, jsx_runtime_1.jsxs)("div", { css: bodyStyle, className: "it-MdContent", children: [slide && (0, jsx_runtime_1.jsx)(Slide_1.Slide, { renderedBody: renderedBody, title: title }), (0, jsx_runtime_1.jsx)(QiitaMarkdownHtmlBody_1.QiitaMarkdownHtmlBody, { renderedBody: renderedBody, bodyRef: bodyRef })] })] }));
};
